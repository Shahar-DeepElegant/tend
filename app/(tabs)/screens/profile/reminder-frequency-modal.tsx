...
export function ReminderFrequencyModal({
  ...
  const [keepPersistent, setKeepPersistent] = useState(true);
  ...
  const [birthdayLeadTime, setBirthdayLeadTime] = useState("1 week before");
  ...
  const toggleDefaultPicker = () => {
    setShowDefaultTimePicker((current) => {
      return !current;
    });
  };
        ...
        <View style={styles.sheet}>
          ...
          >
                ...
                {showDefaultTimePicker ? (
                  <View style={styles.pickerWrap}>
                    <DatePicker
                      ...
                      mode="time"
                      onChange={onChangeDefaultTime}
                    />
                    {Platform.OS === "ios" ? (
                      <Pressable
                        style={styles.pickerDone}
                        onPress={() => setShowDefaultTimePicker(false)}
                      >
            ...
            <GardenCard style={styles.card}>
              <View style={styles.row}>
                <View style={styles.rowCopy}>
                  <GardenText variant="body">Contact Events</GardenText>
                  <GardenText variant="meta" color="#6A7868">
                    Includes birthdays, anniversaries, and any custom dates you
                    add for contacts.
                  </GardenText>
                </View>
                <Switch
              ...
              {birthdayEnabled ? (
                <View style={styles.eventSettings}>
                  ...
                  <View style={styles.chipsRow}>
                    {eventLeadOptions.map((option) => {
                      const selected = birthdayLeadTime === option;
                      return (
                        <Pressable
                          key={option}
                          onPress={() => setBirthdayLeadTime(option)}
                          style={[
                            styles.chip,
